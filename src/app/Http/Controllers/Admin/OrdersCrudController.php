...
class OrdersCrudController extends CrudController
{
    ...
    {
        CRUD::column('id');
        CRUD::column('deliver_to');
        CRUD::column('product_category');
        CRUD::column('product_quantity');
        CRUD::column('product_brand');
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('deliver_to');
        CRUD::field('product_category');
        CRUD::field('product_quantity');
        CRUD::field('product_brand');
    }
